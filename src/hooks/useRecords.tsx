...
interface RecordsContextType {
  records: Record[]
  loading: boolean
  addRecord: (record: Omit<Record, 'id' | 'created_at' | 'updated_at' | 'user_id' | 'hourly_rate'>) => Promise<Record | undefined>
...
export function RecordsProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <RecordsContext.Provider value={{ records, loading, addRecord, updateRecord, deleteRecord, refetch: fetchRecords }}>
      {children}
